...
//З клавіатури ввести послідовність записів, які містять дані для комп’ютерного тестування школярів: 
...
//до кожного з яких школяр повинен ввести відповідь. Вказати правильність кожної відповіді – 
//у випадку помилки назвати вірний варіант. 
include"stdafx.h"
#include<iomanip>
#include<iostream>
#include <string>
